      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-xl font-bold text-slate-800 dark:text-slate-200">Product Management</h1>
          </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-blue-50/80 dark:bg-blue-900/20 border-b border-gray-400 dark:border-blue-900/30">
                  ...
                  <th className="text-center p-4 font-medium text-slate-700 dark:text-slate-300">Price (₹)</th>
                  <th className="text-center p-4 font-medium text-slate-700 dark:text-slate-300">Stock</th>
                    ...
                    <tr key={item.id} className="hover:bg-blue-50/50 dark:hover:bg-blue-900/10 transition-colors">
                      ...
                      <td className="p-4 border-b border-gray-400 dark:border-blue-900/30">
                        <div className="flex justify-center items-center space-x-2">
                          ...
                          <Button
                            onClick={() => router.push(`/admin/product/edit-product/${item.id}`)}
                            variant="outline"
                            size="sm"
                            className="rounded-lg border-blue-200 hover:border-blue-300 dark:border-blue-900/50 dark:hover:border-blue-800 bg-blue-50/50 hover:bg-blue-100/50 dark:bg-blue-900/20 dark:hover:bg-blue-900/30 text-blue-600 dark:text-blue-400"
                          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {loading ? (
                ...
                <CardContent className="p-4 pt-0">
                  ...
                  <div className="flex justify-between items-center mt-2">
                    <div className="flex items-center">
                      <IndianRupee size={14} className="text-blue-500 dark:text-blue-400" />
            ...
            <div className="col-span-full p-12 flex flex-col items-center justify-center bg-white dark:bg-slate-800 rounded-lg border border-gray-400 dark:border-blue-900/30">
              ...
              <h3 className="text-xl font-medium text-slate-800 dark:text-slate-200">No products found</h3>
        ...
        <DialogContent className="sm:max-w-3xl max-h-[90vh] overflow-y-auto border border-blue-200 dark:border-blue-900/50">
          <DialogHeader>
            <DialogTitle className="flex items-center justify-between text-xl text-slate-800 dark:text-slate-200">
              ...
              {previewProduct?.status === "active" ? (
                ...
                <Badge variant="secondary" className="bg-slate-100 text-slate-800 dark:bg-slate-800 dark:text-slate-400">Inactive</Badge>
              )}
            </DialogTitle>
            <DialogDescription className="flex flex-wrap gap-2">
              <Badge variant="outline" className="bg-blue-50 text-blue-700 border-blue-200 dark:bg-blue-900/30 dark:text-blue-300 dark:border-blue-800 flex items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3">
              ...
              <div className="mt-1 space-y-2 bg-blue-50/50 dark:bg-blue-900/10 p-3 rounded-lg border border-gray-400 dark:border-blue-900/30">
                ...
                {previewProduct?.tax && (
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-slate-800 dark:text-slate-200">{previewProduct.tax}%</span>
                  </div>
                )}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-1 space-y-2 bg-blue-50/50 dark:bg-blue-900/10 p-3 rounded-lg border border-gray-400 dark:border-blue-900/30">
                ...
                <div className="flex justify-between">
                  <span className="text-slate-600 dark:text-slate-400">Quantity Limit:</span>
                  <span className="font-medium text-slate-800 dark:text-slate-200">
                    {previewProduct?.quantity_limit}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-600 dark:text-slate-400">HSN Code:</span>
                  <span className="font-medium text-slate-800 dark:text-slate-200">
          ...
          <div className="mt-3">
            ...
            <div className="mt-1 flex flex-wrap gap-4 bg-blue-50/50 dark:bg-blue-900/10 p-3 rounded-lg border border-gray-400 dark:border-blue-900/30">
              ...
              <div className="flex items-center">
                <ShoppingCart size={16} className="text-blue-500 dark:text-blue-400 mr-2" />
                <span className="text-slate-700 dark:text-slate-300">
              ...
              {previewProduct?.weight && (
                <div className="flex items-center">
                  <PackageOpen size={16} className="text-blue-500 dark:text-blue-400 mr-2" />
                  <span className="text-slate-700 dark:text-slate-300">Weight: {previewProduct.weight} kg</span>
                </div>
              )}
            </div>
          </div>
                ...
                <AccordionItem value="seo" className="border-gray-400 dark:border-blue-900/30">
                  ...
                  <AccordionContent>
                    <div className="space-y-3 text-sm bg-blue-50/50 dark:bg-blue-900/10 p-3 rounded-lg border border-gray-400 dark:border-blue-900/30">
                      ...
                      {previewProduct?.meta_keywords && (
                        <div>
                          <span className="font-medium text-slate-700 dark:text-slate-300">Meta Keywords:</span>
                          <p className="mt-1 text-slate-600 dark:text-slate-400">
                            {previewProduct.meta_keywords}
                          </p>
                        </div>
          ...
          <DialogFooter className="mt-4">
            ...
            {previewProduct && (
              <Button
                onClick={() => {
                  router.push(`/admin/product/edit-product/${previewProduct.id}`);
