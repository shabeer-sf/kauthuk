  ...
  if (loading && !products.length) {
    return (
      <div className="min-h-screen bg-[#F9F4F0] flex flex-col items-center justify-center p-4">
        ...
        <p className="text-gray-600 animate-pulse text-lg" style={{ fontFamily: "Poppins, sans-serif" }}>Loading subcategory...</p>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-[#F9F4F0] flex flex-col items-center justify-center p-4">
        <div className="bg-white rounded-xl shadow-md p-8 max-w-md w-full text-center">
          ...
          <h2 className="text-2xl font-bold text-[#6B2F1A] mb-2" style={{ fontFamily: "Playfair Display, serif" }}>Subcategory Not Found</h2>
    ...
    <div className="bg-[#F9F4F0] min-h-screen">
      ...
      <div className="bg-gradient-to-r from-[#6B2F1A] to-[#b38d4a] text-white">
        <div className="container mx-auto px-4 py-16">
            ...
            <BreadcrumbList>
              ...
              {parentCategory && (
                <>
                  <BreadcrumbSeparator className="text-white/60" />
                  <BreadcrumbItem>
                    <BreadcrumbLink href={`/category/${parentCategory.id}`} className="text-white/80 hover:text-white" style={{ fontFamily: "Poppins, sans-serif" }}>
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div>
              <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ fontFamily: "Playfair Display, serif" }}>{subcategory?.subcategory || "Subcategory"}</h1>
      ...
      {relatedSubcategories.length > 0 && (
        <section className="py-12 bg-[#F9F4F0]">
          <div className="container mx-auto px-4">
            <h2 className="text-2xl font-bold text-[#6B2F1A] mb-8" style={{ fontFamily: "Playfair Display, serif" }}>Related Subcategories</h2>
              ...
              {relatedSubcategories.map((sub) => (
                ...
                >
                  <CardContent className="p-6 flex flex-col items-center justify-center text-center">
                    ...
                    <h3 className="font-medium text-[#6B2F1A] line-clamp-1" style={{ fontFamily: "Playfair Display, serif" }}>{sub.subcategory}</h3>
                    <p className="text-sm text-gray-500 mt-1" style={{ fontFamily: "Poppins, sans-serif" }}>{sub._count?.Product || 0} items</p>
                  </CardContent>
                </Card>
              ))}
            </div>
