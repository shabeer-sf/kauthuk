      ...
      >
        <div className="relative aspect-square overflow-hidden">
          ...
          >
            ...
            <button 
              type="button"
              className={`w-10 h-10 rounded-full bg-white text-gray-800 flex items-center justify-center hover:bg-indigo-500 hover:text-white transition-colors shadow-md ${!inStock ? 'opacity-50 cursor-not-allowed' : ''}`}
